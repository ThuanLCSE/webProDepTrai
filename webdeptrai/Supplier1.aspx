...
<asp:Content id="inputContent" ContentPlaceHolderID="panelEdit" runat="server"> 
      <div width="100%">
         ...
         <div> 
             ...
             <asp:TextBox ID="lblSupID"  CssClass="control-label txt1" runat="server"></asp:TextBox>
         ...
         <div>
                ...
                ControlToValidate = "txtSupplierName" ID="RegularExpressionValidator2" ValidationExpression = "^[\s\S]{3,40}$" 
         ...
         <div>
               ...
               <asp:RegularExpressionValidator Display = "Dynamic" 
               ControlToValidate = "txtContactName" ID="RegularExpressionValidator3" ValidationExpression = "^[\s\S]{3,30}$" 
         ...
         <div>   
                ...
                <asp:RegularExpressionValidator Display = "Dynamic" 
                ControlToValidate = "txtContactTilte" ID="RegularExpressionValidator4" ValidationExpression = "^[\s\S]{3,30}$" 
                runat="server" ErrorMessage="Minimum 3 characters, Maximum 30 characters allowed.">
                </asp:RegularExpressionValidator>          
        ...
        <div>       
                ...
                <asp:RegularExpressionValidator Display = "Dynamic" 
                ControlToValidate = "txtAddress" ID="RegularExpressionValidator5" ValidationExpression = "^[\s\S]{3,60}$" 
                runat="server" ErrorMessage="Minimum 3 characters, Maximum 60 characters allowed.">
                </asp:RegularExpressionValidator>
        ...
        <div>    
                ...
                runat="server" ErrorMessage="Minimum 3 characters, Maximum 10 characters allowed.">
                </asp:RegularExpressionValidator> 
